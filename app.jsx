...
function App(props){
  ...
  if(!authed){
    return appR.createElement('div', { dir:dir, style:Object.assign({ position:'absolute', inset:0 }, rootVars) },
      appR.createElement(window.Onboarding, { lang:lang, onDone:function(){ setAuthed(true); } })
    );
  }
